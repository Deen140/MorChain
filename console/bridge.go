...
import (
	...
	"github.com/morchain/go-morchain/accounts/scwallet"
	"github.com/morchain/go-morchain/accounts/usbwallet"
...
type bridge struct {
	client   *rpc.Client         // RPC client to execute morchain requests through
