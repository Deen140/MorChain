...
// Package bind generates morchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-morchain Wiki page:
// https://github.com/morchain/go-morchain/wiki/Native-DApps:-Go-bindings-to-morchain-contracts
package bind
