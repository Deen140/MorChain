...
// all blocks' seal as valid, though they still have to conform to the morchain
// consensus rules.
...
// still have to conform to the morchain consensus rules.
...
// they still have to conform to the morchain consensus rules.
