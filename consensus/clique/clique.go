...
import (
	...
	lru "github.com/morchain/go-morchain/common/lru"
...
// ecrecover extracts the morchain account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the morchain address
...
// morchain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // morchain address of the signing key
...
// Author implements consensus.Engine, returning the morchain address recovered
