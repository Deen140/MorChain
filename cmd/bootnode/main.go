...
// bootnode runs a bootstrap node for the morchain Discovery Protocol.
package main
...
import (
	...
	"github.com/morchain/go-morchain/cmd/utils"
	"github.com/morchain/go-morchain/crypto"
	"github.com/morchain/go-morchain/log"
	"github.com/morchain/go-morchain/p2p/discover"
...
func main() {
	...
	if natm != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(natm, nil, "udp", realaddr.Port, realaddr.Port, "morchain discovery")
		}
